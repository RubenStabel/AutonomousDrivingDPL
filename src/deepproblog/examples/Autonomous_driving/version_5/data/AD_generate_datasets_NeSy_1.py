...
# train_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/balanced/version_5_env_5_tl_pos'
# test_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/balanced/version_5_env_5_tl_pos'
# test_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/general/version_5_env_5_tl_pos'


# train_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/balanced/dev/small'
# test_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/scenario'

train_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/balanced/dev/small'
test_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/balanced/dev/medium'
...
# test_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/general/biased_version_5_env_5_20:1'

# train_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/experiments/exp_noise/train'
# test_data_path = '/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/experiments/exp_noise/test'
...
def image_file_to_traffic_light_y(image_data_path: str, df):
    image_name = image_data_path.split('/')[-1]
    image_id = image_name.split('_')[-1].split('.')[0]
    iter_image = image_id.split('frame')[0].split('iter')[-1]
    frame = image_id.split('frame')[-1]

    tl_y = df[(df['iteration'] == int(iter_image)) & (df['image_frame'] == int(frame))]['traffic_light_y'].values[0]
    return tl_y
...
class AD_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        tl_pos = self._get_traffic_light_y(idx)
        player_car_y = self._get_player_car_y(idx)
        return image, MNIST_img, speed, player_car_y, tl_pos, INTER_1_END, label
    ...
    def _get_traffic_light_y(self, idx: int):
        image_path = self.image_paths[idx]
        return image_file_to_traffic_light_y(image_path, self.simulation_data)
    ...
    def to_query(self, i):
        image, MNIST_img_idx, speed, player_car_y, tl_pos, intersection_y, label = self.__getitem__(i)
        return Query(
            Term("action",
