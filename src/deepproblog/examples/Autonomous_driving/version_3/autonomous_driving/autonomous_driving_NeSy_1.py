...
from deepproblog.examples.Autonomous_driving.version_3.networks.network_NeSy import AD_V3_NeSy_1_net_danger_pedestrian, \
    AD_V3_NeSy_1_net_speed_zone, AD_V3_NeSy_1_net_traffic_light, AD_V3_NeSy_1_net_danger
from deepproblog.model import Model
from deepproblog.network import Network
from deepproblog.train import train_model
from deepproblog.evaluate import get_confusion_matrix

from deepproblog.examples.Autonomous_driving.version_3.data.AD_generate_datasets_NeSy_1 import get_dataset, MNIST_train
...
network_1 = AD_V3_NeSy_1_net_danger_pedestrian()
...
network_2 = AD_V3_NeSy_1_net_speed_zone()
...
network_3 = AD_V3_NeSy_1_net_traffic_light()
...
network_4 = AD_V3_NeSy_1_net_danger()
...
train = train_model(model, loader, 10, test_set=valid_set, log_iter=5, profile=0, save_best_model='/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/deepproblog/examples/Autonomous_driving/version_3/snapshot/neuro_symbolic/best_test/{}'.format(name + '.pth'))
