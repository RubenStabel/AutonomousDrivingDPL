...
from deepproblog.examples.Autonomous_driving.version_3.data.AD_generate_datasets_NeSy_3 import get_dataset, MNIST_train
...
print("###############    LOADING MODEL    ###############")
model = Model("../models/autonomous_driving_NeSy_3.pl", [net_ped, net_spd, net_tl])
