...
def accuracy_on_actions():
    baseline_train_data = data_2_pd_acc('../log/baseline/train/autonomous_driving_baseline_0_complete_env_3_0.log')
    baseline_test_data_small = data_2_pd_acc('../log/baseline/test/autonomous_driving_baseline_0_small_env_3_0.log')
    baseline_test_data_medium = data_2_pd_acc_n('../log/neuro_symbolic/test/autonomous_driving_NeSy_3_medium_env_3_pretrain_2.log')
    baseline_test_data_complete = data_2_pd_acc('../log/baseline/test/autonomous_driving_baseline_0_complete_env_3_0.log')

    NeSy_0_train_data = data_2_pd_acc('../log/neuro_symbolic/train/autonomous_driving_NeSy_0_complete_env_3_0.log')
    NeSy_0_test_data_small = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_small_env_3_0.log')
    NeSy_0_test_data_medium = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_medium_env_3_0.log')
    NeSy_0_test_data_complete = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_complete_env_3_0.log')
    #
    ...
    #     [baseline_test_data_small, NeSy_0_test_data_small],
    #     ['baseline - SMALL', 'NeSy_0 - SMALL'], ['accuracy'], 'V3_env_3_data_small_pretrain')
    multiple_running_metrics(
        [baseline_test_data_medium, NeSy_0_test_data_medium],
        ['pretrain - MEDIUM', 'NeSy_0 - MEDIUM'], ['accuracy'], 'V3_env_3_data_medium_pretrain')
    # multiple_running_metrics(
    #     [baseline_test_data_complete, NeSy_0_test_data_complete],
    #     ['baseline - COMPLETE', 'NeSy_0 - COMPLETE'], ['accuracy'], 'V3_env_3_data_complete')
