...
transform = transforms.Compose([
                transforms.ToTensor(),
                transforms.Resize((64, 64), antialias=True, interpolation=InterpolationMode.BILINEAR),
                transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
                ])
show_transformed_img('/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/data/img/balanced/version_3_env_3/complete/1/0_iter2frame14.png', transform)