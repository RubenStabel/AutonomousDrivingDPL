...
from deepproblog.examples.Autonomous_driving.version_1.networks.network_NeSy import AD_V1_NeSy_1_net_y, AD_V1_NeSy_0_net
...
net = Network(network, "perc_net_version_1_NeSy_0", batching=True)
