...
from deepproblog.examples.Autonomous_driving.version_1.data.AD_generate_datasets_baseline import get_dataset
...
net = Network(network, "perc_net_version_1_baseline", batching=True)
