...
def accuracy_on_actions():
    ...
    baseline_test_data_complete = data_2_pd_acc('../log/baseline/test/autonomous_driving_baseline_0_complete_env_4_0.log')
    ...
    NeSy_0_test_data_complete = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_complete_env_4_0.log')
    #
    ...
    multiple_running_metrics(
        ...
        ['baseline - COMPLETE', 'NeSy_0 - COMPLETE'], ['accuracy'], 'V4_env_5_data_complete')
