...
from deepproblog.examples.Autonomous_driving.version_4.data.AD_generate_datasets_baseline_0 import get_dataset, MNIST_train
from deepproblog.model import Model
from deepproblog.network import Network
from deepproblog.train import train_model
from deepproblog.evaluate import get_confusion_matrix
from deepproblog.examples.Autonomous_driving.version_4.networks.network_baseline import AD_V4_baseline_net_0
...
network = AD_V4_baseline_net_0()
net = Network(network, "perc_net_version_4_baseline_0", batching=True)
...
train = train_model(model, loader, 15, test_set=valid_set, log_iter=5, profile=0, save_best_model='/Users/rubenstabel/Documents/Thesis/Implementation/AutonomousDrivingDPL/src/deepproblog/examples/Autonomous_driving/version_4/snapshot/baseline/best_test/{}'.format(name + '.pth'))
