...
def accuracy_on_actions():
    baseline_train_data = data_2_pd_acc('../log/baseline/train/autonomous_driving_baseline__medium_0.log')
    baseline_test_data_small = data_2_pd_acc('../log/baseline/test/autonomous_driving_baseline__small_0.log')
    baseline_test_data_medium = data_2_pd_acc('../log/baseline/test/autonomous_driving_baseline__medium_0.log')
    baseline_test_data_complete = data_2_pd_acc('../log/baseline/test/autonomous_driving_baseline__complete_0.log')

    NeSy_0_train_data = data_2_pd_acc('../log/neuro_symbolic/train/autonomous_driving_NeSy_0_medium_0.log')
    NeSy_0_test_data_small = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_small_0.log')
    NeSy_0_test_data_medium = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_medium_0.log')
    NeSy_0_test_data_complete = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_complete_0.log')
    NeSy_0_test_data_complete_1 = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_0_complete_1.log')

    NeSy_1_train_data = data_2_pd_acc('../log/neuro_symbolic/train/autonomous_driving_NeSy_1_medium_0.log')
    NeSy_1_test_data_small = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_1_small_0.log')
    NeSy_1_test_data_medium = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_1_medium_0.log')
    NeSy_1_test_data_complete = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_1_complete_0.log')

    NeSy_2_train_data = data_2_pd_acc('../log/neuro_symbolic/train/autonomous_driving_NeSy_2_medium_0.log')
    NeSy_2_test_data_small = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_2_small_0.log')
    NeSy_2_test_data_medium = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_2_medium_0.log')
    NeSy_2_test_data_complete = data_2_pd_acc('../log/neuro_symbolic/test/autonomous_driving_NeSy_2_complete_0.log')
    ...
    multiple_running_metrics([baseline_test_data_small, NeSy_1_test_data_small], ['baseline - SMALL', 'NeSy_1 - SMALL'], ['accuracy'])
    multiple_running_metrics([baseline_test_data_medium, NeSy_1_test_data_medium], ['baseline - MEDIUM', 'NeSy_1 - MEDIUM'], ['accuracy'])
    multiple_running_metrics([baseline_test_data_complete, NeSy_1_test_data_complete], ['baseline - COMPLETE', 'NeSy_1 - COMPLETE'], ['accuracy'])
