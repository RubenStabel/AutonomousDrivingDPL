...
from deepproblog.examples.Autonomous_driving.version_0.networks.network_NeSy import AD_V0_NeSy_2_net

N = 0
folder = "test/"
data_size = "complete"

name = "autonomous_driving_NeSy_2_{}_{}".format(data_size, N)
...
net = Network(network, "perc_net_version_0_NeSy_2", batching=True)
net.optimizer = torch.optim.Adam(network.parameters(), lr=1e-3)

print("###############    LOADING MODEL    ###############")
model = Model("../models/autonomous_driving_NeSy_2.pl", [net])
