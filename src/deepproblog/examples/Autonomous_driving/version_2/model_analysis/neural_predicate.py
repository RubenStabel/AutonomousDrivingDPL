...
class AD_Eval_Image(Dataset):
    def __init__(self, image_path, mnist_idx, eval_name, transform=None):
...
def get_nn_prediction_probs(data, mnist_idx, speed, model):
    datasets = {
        "eval_image": AD_Eval_Image(data, mnist_idx, speed, "eval_image"),  # test transforms are applied
    }
