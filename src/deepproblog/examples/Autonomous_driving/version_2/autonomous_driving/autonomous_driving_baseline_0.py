...
from deepproblog.examples.Autonomous_driving.version_2.networks.network_baseline import AD_V2_baseline_net_0

N = 0
folder = "test/"

name = "autonomous_driving_baseline_0_{}".format(N)
...
net = Network(network, "perc_net_version_2_baseline_0", batching=True)
