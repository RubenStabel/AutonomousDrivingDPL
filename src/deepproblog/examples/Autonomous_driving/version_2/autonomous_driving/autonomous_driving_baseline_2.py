...
from deepproblog.examples.Autonomous_driving.version_2.data.AD_generate_datasets_baseline_2 import get_dataset, MNIST_train
...
name = "autonomous_driving_baseline_2_{}_{}_{}".format(data_size, env, N)
...
net = Network(network, "perc_net_version_2_baseline_2", batching=True)
net.optimizer = torch.optim.Adam(network.parameters(), lr=1e-3)

print("###############    LOADING MODEL    ###############")
model = Model("../models/autonomous_driving_baseline_2.pl", [net])
