...
from deepproblog.examples.AD_V0.data.AD_generate_datasets_V2 import AD_train, AD_valid, get_dataset, AD_test
...
name = "autonomous_driving_baseline_NeSy_V2_{}".format(N)
