...
from deepproblog.examples.AD_V0.data.AD_generate_datasets_V2_1 import AD_train, AD_valid, get_dataset, AD_test
from deepproblog.examples.AD_V0.network import AD_V2_1_net
...
name = "autonomous_driving_baseline_NeSy_V2_1_{}".format(N)
...
network = AD_V2_1_net()
net = Network(network, "ad_baseline_speed_net", batching=True)
net.optimizer = torch.optim.Adam(network.parameters(), lr=1e-3)

print("###############    LOADING MODEL    ###############")
model = Model("../models/autonomous_driving_baseline_V2_1.pl", [net])
